...
public class Eap7xAsTestsuiteTest710 extends AbstractEapAsTestsuite {
   ...
   private static final FilterItem[] FILTER_ITEMS = {
       ...
       // https://issues.jboss.org/browse/JBEAP-5420 - CLIScriptSupportTestCase fails on pure-IPv6 machines
       new FilterItem(Colour.YELLOW).addUrl(".*core.*")
           .addTest("org.jboss.as.test.manualmode.management.cli.CLIScriptSupportTestCase#testConnectStatus")
           .setErrorText("https://issues.jboss.org/browse/JBEAP-5420 - CLIScriptSupportTestCase fails on pure-IPv6 machines")
   };
}
